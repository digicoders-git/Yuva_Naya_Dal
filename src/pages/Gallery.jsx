                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-navy-flag/80 via-navy-flag/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                                    <div className="absolute bottom-4 left-4 right-4 text-white text-xs md:text-sm">
                                        ...
                                        {num === 37 && (
                                            <p className="font-bold">
                                                  गगन बाजपेई - राष्ट्रीय उपाध्यक्ष , लखनऊ उत्तर प्रदेश
                                            </p>
                                        )}
                                         {num === 38 && (
                                            <p className="font-bold">
                                                  शुभम गुप्ता - राष्ट्रीय महासचिव , लखनऊ उत्तर प्रदेश
                                            </p>
                                        )}
                                         {num === 40 && (
                                            <p className="font-bold">
                                                  शिव कुमार सिंह - राष्ट्रीय प्रवक्ता ,अमेठी, उत्तर प्रदेश
                                            </p>
                                        )}
                                        {num === 41 && (
                                            <p className="font-bold">
                                                  राजेंद्र सिंह - राष्ट्रीय सचिव , रायबरेली, उत्तर प्रदेश
                                            </p>
                                        )}
                                        {num === 42 && (
                                            <p className="font-bold">
                                                  नागेन्द्र द्विवेदी - राष्ट्रीय उपाध्यक्ष ,फतेहपुर , उत्तर प्रदेश
                                            </p>
                                        )}
                                        {num === 43 && (
                                            <p className="font-bold">
                                                  निहाल कुमार-  राष्ट्रीय उपाध्यक्ष, प्रयागराज ,उत्तर प्रदेश
                                            </p>
                                        )}
                                    </div>
                                </div>
