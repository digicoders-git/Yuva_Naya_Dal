                    ...
                    <div className="flex flex-col items-center gap-0">
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="w-full flex flex-col items-center">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
                                ...
                                <LeaderCard
                                    image={image123}
                                    name="विवेक कुमार वर्मा"
                                    title="राष्ट्रीय उपाध्यक्ष"
                                    subtitle="लखनऊ, उत्तर प्रदेश"
                                    delay={0.6}
                                    position="object-top object-contain"
                                    onClick={() => setSelectedImage({ img: image123, name: "विवेक कुमार वर्मा" })}
                                />
                        ...
                        <div className="flex flex-col items-center my-1">
                            ...
                            <div className="w-3 h-3 rounded-full bg-green-flag/60"/>
                                ...
                                <LeaderCard
                                    image={image119}
                                    name="पियूष तिवारी"
                                    title="राष्ट्रीय संगठन मंत्री"
                                    subtitle="मध्य प्रदेश"
                                    delay={0.1}
                                    position="object-top object-contain"
                                    onClick={() => setSelectedImage({ img: image119, name: "पियूष तिवारी" })}
                                />
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }} className="w-full flex flex-col items-center">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-2 gap-6 w-full max-w-2xl">
                                ...
                                />
                                  <LeaderCard
                                    image={image78}
                                    name="सूर्य कुमार शुक्ला"
                                    title="राष्ट्रीय प्रवक्ता"
                                    // subtitle="फतेहपुर, उत्तर प्रदेश"
                                    delay={0.6}
                                    position="object-top object-contain"
                                    onClick={() => setSelectedImage({ img: image78, name: "सूर्य कुमार शुक्ला" })}
                                />
                            </div>
                        </motion.div>
...
"
                                    delay={0.6}
                                    position="object-top object-contain"
                                    onClick={() => setSelectedImage({ img: image118, name: "राज नारायण जी," })}
                                />
                ...
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="flex flex-col items-center gap-0">
                        ...
                        <div className="max-w-xs w-full">
                            <LeaderCard
                                image={image93}
                                name="माननीय श्रीमती हेमा सैनी"
                                title="राष्ट्रीय उपाध्यक्ष"
                                subtitle="नेतृत्व महिला"
                                delay={0.2}
                                position="object-top object-contain"
                                onClick={() => setSelectedImage({ img: image93, name: "माननीय श्रीमती हेमा सैनी" })}
                            />
                        ...
                        <div className="max-w-xs w-full">
                            <LeaderCard
                                image={image94}
                                name="माननीय सुश्री अनिंदर कौर"
                                title="राष्ट्रीय महासचिव"
                                subtitle="नेतृत्व महिला"
                                delay={0.2}
                                position="object-top object-contain"
                                onClick={() => setSelectedImage({ img: image94, name: "माननीय सुश्री अनिंदर कौर" })}
                            />
                        </div>
                        ...
                        <div className="flex flex-col items-center my-1">
                         ...
                         <div className="max-w-xs w-full">
                            <LeaderCard
                                image={image103}
                                name="माननीय रमेश कुमार तिवारी"
                                title="राष्ट्रीय अध्यक्ष"
                                subtitle="नेतृत्व युवा संस्कृति"
                                delay={0.2}
                                position="object-top object-contain"
                                onClick={() => setSelectedImage({ img: image103, name: "माननीय रमेश कुमार तिवारी" })}
                            />
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-0">
                        ...
                        <div className="flex flex-col items-center my-1">
                            ...
                            <div className="w-3 h-3 rounded-full bg-saffron/60"/>
                             ...
                             <LeaderCard
                                image={image108}
                                name="श्रीमती विभा कुमारी"
                                title="प्रदेश अध्यक्ष ,महिला नेतृत्व"
                                subtitle="बंगाल राज्य"     
                                delay={0.2}
                                position="object-top object-contain"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
                        ...
                        />
                                ...
                                <LeaderCard
                                    ...
                                    delay={0.3}
                                    position="object-top object-contain"
                                    onClick={() => setSelectedImage({ img: image120, name: "मनीष जी" })}
                                />
                                ...
                                <LeaderCard
                                    ...
                                    delay={0.3}
                                    position="object-top object-contain"
                                    onClick={() => setSelectedImage({ img: image124, name: "प्रांजल जी" })}
                                />
            ...
            <section className="pt-6 pb-12 px-4 md:px-6 bg-slate-50 relative overflow-hidden">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
                        ...
                        <LeaderCard
                            image={image56}
                            name="भूपेन्द्र भारद्वाज"
                            title="जिला अध्यक्ष"
                            subtitle="आगरा, उत्तर प्रदेश"
                            delay={0.6}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image56, name: "भूपेन्द्र भारद्वाज" })}
                        />
                        <LeaderCard
                            image={image57}
                            name="ओमकार सिंह यादव"
                            title="जिला अध्यक्ष"
                            subtitle="कानपुर नगर, उत्तर प्रदेश"
                            delay={0.6}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image57, name: "ओमकार सिंह यादव" })}
                        />
                        ...
                        />
                         <LeaderCard
                            image={image60}
                            name="गौरव श्रीवास्तव"
                            title="जिला अध्यक्ष"
                            subtitle="बनारस, उत्तर प्रदेश"
                            delay={0.6}
                            position="object-top object-contain"
                        ...
                        <LeaderCard
                            ...
                            name="मयंक जी"
                            title="जिला अध्यक्ष"
                            subtitle="लखीमपुर खीरी, उत्तर प्रदेश"
                            delay={0.6}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image62, name: "मयंक जी" })}
                        />
                        <LeaderCard
                            image={image63}
                            name="करुणेंद्र जी"
                        ...
                        />
                         ...
                         <LeaderCard
                            ...
                            name="अभिषेक कुमार"
                            title="जिला अध्यक्ष"
                            subtitle="बस्ती, उत्तर प्रदेश"
                            delay={0.6}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image85, name: "अभिषेक कुमार" })}
                        />

                        <LeaderCard
                            image={image87}
                            name="शिव प्रताप सिंह बुंदेला"
                            title="जिला अध्यक्ष"
                            subtitle="ललितपुर, उत्तर प्रदेश"
                            delay={0.6}
                            position="object-top object-contain"
                ...
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
                        ...
                        <LeaderCard
                            ...
                            name="विनय द्विवेदी"
                            title="अध्यक्ष"
                            subtitle="लोकसभा क्षेत्र जनपद फतेहपुर, उत्तर प्रदेश"
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image88, name: "विनय द्विवेदी" })}
                        />
                        ...
                        <LeaderCard 
                            ...
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image71, name: "दीपक कुमार" })}
                        />

                         <LeaderCard 
                            image={image72}
                            name="मुकेश पाण्डेय"
                            title="सादर विधानसभा अध्यक्ष"
                            subtitle="फतेहपुर , उत्तर प्रदेश"
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image72, name: "मुकेश पाण्डेय" })}
                        />

                         <LeaderCard 
                            image={image73}
                            name="दिलीप कुमार पासी"
                            title="विधानसभा अध्यक्ष , अयाह शाह"
                            subtitle="फतेहपुर , उत्तर प्रदेश"
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image73, name: "दिलीप कुमार पासी" })}
                        />
                        ...
                        <LeaderCard 
                            image={image79}
                            name="सैफी रिजवी,"
                            title="जिला अध्यक्ष (टीम अल्पसंख्यक)"
                            subtitle="फतेहपुर , उत्तर प्रदेश"
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image79, name: "सैफी रिजवी" })}
                        />
                        ...
                        <LeaderCard 
                            ...
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image104, name: "शिवम जायसवाल" })}
                        />

                         <LeaderCard 
                            image={image105}
                            name="सत्यम कुमार द्विवेदी"
                            title="जिला उपाध्यक्ष"
                            subtitle="मिर्जापुर , उत्तर प्रदेश"
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image105, name: "सत्यम कुमार द्विवेदी" })}
                        />

                        <LeaderCard 
                            image={image106}
                            name="कृष्ण कुमार मोदनवाल"
                            title="जिला कोषाध्यक्ष"
                            subtitle="मिर्जापुर , उत्तर प्रदेश"
                            delay={0.1}
                            position="object-top object-contain"
                        ...
                        <LeaderCard 
                            ...
                            name="देवानंद जी"
                            title="ब्लॉक अध्यक्ष"
                            subtitle="कटरा बाजार, गोंडा"
                            delay={0.1}
                            position="object-top object-contain"
                            onClick={() => setSelectedImage({ img: image121, name: "देवानंद जी" })}
                        />
